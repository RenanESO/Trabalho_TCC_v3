<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Bem-vindo ao seu aplicativo Jetstream!
    </h1>

    <p class="mt-6 text-gray-500 leading-relaxed">
        O Laravel Jetstream fornece um ponto de partida bonito e robusto para seu próximo aplicativo Laravel. O Laravel foi projetado
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            O Laravel Jetstream é construído com Tailwind, um incrível framework CSS utilitário que não atrapalha. Você ficará surpreso com a facilidade com que pode construir e manter designs novos e modernos com esse maravilhoso framework na ponta dos dedos.
        </p>
    </div>
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Visualizações de autenticação e registro estão incluídas no Laravel Jetstream, bem como suporte para verificação de e-mail do usuário e redefinição de senhas esquecidas. Assim, você está livre para começar com o que é mais importante: construir seu aplicativo.
        </p>
    </div>
</div>
